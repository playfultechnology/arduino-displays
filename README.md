...
| ![]() | ST7567 | 3.3V | LCD | 128x64 | I2C |  | https://www.aliexpress.com/item/1005002998072234.html |
...
| ![](Images/TFT_13.jpg)  | 1.3" ST7789 | 3.3/5V | TFT | 240x240 | SPI | https://github.com/Bodmer/TFT_eSPI (see below section for TFT displays) | https://www.aliexpress.com/item/1005006532468602.html |
...
e.g. Using the ST7789 controller, use the TFT_eSPI library, with the following settings in the User_Setup.h file:
```
...
#define TFT_MISO  19   // PIN_D6 Automatically assigned with ESP8266 if not defined
#define TFT_MOSI  23 // PIN_D7  // Automatically assigned with ESP8266 if not defined
#define TFT_SCLK  18 // PIN_D5  // Automatically assigned with ESP8266 if not defined
//#define TFT_CS   -1 // 5 // PIN_D8  // Chip select control pin D8
#define TFT_DC   5 // PIN_D3  // Data Command control pin
//#define TFT_RST   // PIN_D4  // Reset pin (could connect to NodeMCU RST, see next line)
#define TFT_RST  -1     // Set TFT_RST to -1 if the display RESET is connected to NodeMCU RST or 3.3V
#define TFT_BL   22     // PIN_D1  // LED back-light (only for ST7789 with backlight control pin)
